...
def print_all_quality_index(q1, q2, q3, output):
    ...
    # ax0.set_title("Global quality score", fontsize = 15)
    ax0.text(0.33, 0.70, 'Global quality score', fontsize = 14, fontweight='bold', transform=plt.gcf().transFigure)
    ...
    ax1.text(0.67, 0.88, 'Protocol quality score', fontsize = 9, fontweight='bold', transform=plt.gcf().transFigure)
    ...
    ax2.text(0.67, 0.56, 'Intrinsec quality score', fontsize = 9, fontweight='bold', transform=plt.gcf().transFigure)
    ax3 = fig.add_subplot(gs[2, 1], projection='polar')
    ax3 = plot_quality_index(round(np.mean(q3)), ax3, scale = 3)
    # ax3.set_title("Extrinsec quality score", fontsize = 10)
    ax3.text(0.67, 0.35, 'Extrinsec quality score', fontsize = 9, fontweight='bold', transform=plt.gcf().transFigure)
