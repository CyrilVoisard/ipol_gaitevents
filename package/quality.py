...
def print_all_quality_index(q1, q2, q3, output):
    ...
    ax1.text(0.67, 0.85, 'Protocol quality score', fontsize = 9, fontweight='bold', transform=plt.gcf().transFigure)
    ...
    ax2.text(0.67, 0.85, 'Intrinsec quality score', fontsize = 9, fontweight='bold', transform=plt.gcf().transFigure)
